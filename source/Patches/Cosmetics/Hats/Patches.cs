...
public static class HatsTabOnEnablePatch
{
    ...
    private static float CreateHatPackage(List<HatData> hats, string packageName, float YStart, HatsTab __instance)
    {
        ...
        if (Template)
        {
            ...
            Coroutines.Start(Utils.PerformTimedAction(0.1f, _ => title.SetText(packageName)));
    ...
    public static bool Prefix(HatsTab __instance)
    {
        ...
        Template = GameObject.Find("HatsGroup").transform.FindChild("Text").GetComponent<TMPro.TMP_Text>();
