...
namespace TownOfUsFusion.CrewmateRoles.HunterMod
{
    ...
    public class Stalk
    {
        public static bool Prefix(KillButton __instance)
        {
            ...
            if (!PlayerControl.LocalPlayer.Is(AllianceEnum.Crewpostor) && !PlayerControl.LocalPlayer.Is(AllianceEnum.Crewpocalypse) && !PlayerControl.LocalPlayer.Is(AllianceEnum.Recruit)
             && !PlayerControl.LocalPlayer.Is(AllianceEnum.Egotist) && !role.CaughtPlayers.Contains(role.ClosestPlayer)) return false;
