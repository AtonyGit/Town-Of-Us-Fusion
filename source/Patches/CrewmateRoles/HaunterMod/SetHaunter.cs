...
public class SetHaunter
{
    ...
    public static void ExileControllerPostfix(ExileController __instance)
    {
        ...
        if (!WillBeHaunter.Data.IsDead && exiled.Is(Faction.Crewmates) && !exiled.Is(AllianceEnum.Lover) && !exiled.Is(AllianceEnum.Crewpocalypse) && !exiled.Is(AllianceEnum.Crewpostor)
        && !exiled.Is(AllianceEnum.Recruit) && !exiled.Is(AllianceEnum.Egotist)) WillBeHaunter = exiled;
