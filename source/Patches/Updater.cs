...
public class ModUpdater
{
    ...
    public static void LaunchUpdater()
    {
        ...
        string submergedPath = System.Uri.UnescapeDataString(uri.Path.Replace("TownOfUsFusion", "Submerged"));
    ...
    public static async Task<bool> checkForUpdate(string updateType = "TOU")
    {
        ...
        try
        {
            ...
            http.DefaultRequestHeaders.Add("User-Agent", "TownOfUsFusion Updater");
