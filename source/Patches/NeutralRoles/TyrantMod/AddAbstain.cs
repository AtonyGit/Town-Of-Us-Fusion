...
namespace TownOfUsFusion.NeutralRoles.TyrantMod
{
    ...
    {
        public static void UpdateButton(Tyrant role, MeetingHud __instance)
        {
        ...
        {
            public static void GenButton(Tyrant role, MeetingHud __instance)
            {
                var skip = __instance.SkipVoteButton;
            ...
            public static void Postfix(MeetingHud __instance)
            {
                ...
                var mayorRole = Role.GetRole<Tyrant>(PlayerControl.LocalPlayer);
