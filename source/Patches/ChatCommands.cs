        ...
        public static class PrivateJaileeChat
        {
            ...
            public static void AddRoleMessage(RoleEnum role)
            {
                switch (role)
                {
                    ...
                    break;
                    case RoleEnum.Captain: DestroyableSingleton<HudManager>.Instance.Chat.AddChat(
                        PlayerControl.LocalPlayer, "The Captain is a crewmate who can cause a tribunal within a meeting, ejecting more than one person in a single meeting.");
                    break;
                    case RoleEnum.TimeLord: DestroyableSingleton<HudManager>.Instance.Chat.AddChat(
                        PlayerControl.LocalPlayer, "The Time Lord is a crewmate who can rewind time, undoing movements and actions of all players.");
                    break;
                    ...
                    case RoleEnum.Lawyer: DestroyableSingleton<HudManager>.Instance.Chat.AddChat(PlayerControl.LocalPlayer,
                        "The Lawyer is a neutral benign role with the goal of keeping their target alive till the end of the game. They may also chat with their client privately.");
                    break;
                    ...
                    case RoleEnum.Tyrant: DestroyableSingleton<HudManager>.Instance.Chat.AddChat(PlayerControl.LocalPlayer,
                        "The Tyrant is a neutral chaos role with the intention of helping any neutrals win. They have a vote bank which they can unleash at any time to eliminate the Crewmates and Impostors.");
                    break;
