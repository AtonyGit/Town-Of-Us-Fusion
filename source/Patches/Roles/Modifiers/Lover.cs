    ...
    public class Lover : Modifier
{
    ...
    public static void Gen(List<PlayerControl> canHaveModifiers)
    {
        ...
        {
            if (player.Is(Faction.Impostors) || player.Is(Faction.NeutralKilling) || ((player.Is(Faction.NeutralNeophyte) && !player.Is(RoleEnum.Vampire) || player.Is(Faction.NeutralApocalypse)) && CustomGameOptions.NeutralLovers))
