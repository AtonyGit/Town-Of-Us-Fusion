...
namespace TownOfUsFusion.Roles.Modifiers
{
    public class Assassin : Ability, IGuesser
    {
        ...
        public Assassin(PlayerControl player) : base(player)
        {
            ...
            if (CustomGameOptions.DetectiveOn > 0) ColorMapping.Add("Coroner", Colors.Coroner);
            ...
            {
                if (CustomGameOptions.PlaguebearerOn > 0 && !PlayerControl.LocalPlayer.Is(Faction.NeutralApocalypse)) ColorMapping.Add("Plaguebearer", Colors.Apocalypse);
                if (CustomGameOptions.JuggernautOn > 0 && !PlayerControl.LocalPlayer.Is(Faction.NeutralApocalypse)) ColorMapping.Add("Juggernaut", Colors.Apocalypse);
                if (CustomGameOptions.SoulCollectorOn > 0 && !PlayerControl.LocalPlayer.Is(Faction.NeutralApocalypse)) ColorMapping.Add("Soul Collector", Colors.Apocalypse);
            }
